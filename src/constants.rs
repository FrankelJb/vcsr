...
pub const DEFAULT_METADATA_FONT: &str = "resources/DejaVuSans.ttf";
...
pub const DEFAULT_START_DELAY_PERCENT: u32 = 7;
pub const DEFAULT_END_DELAY_PERCENT: u32 = DEFAULT_START_DELAY_PERCENT;
pub const DEFAULT_DELAY_PERCENT: Option<u32> = None;
...
pub const DEFAULT_TIMESTAMP_FONT: &str = "resources/DejaVuSans.ttf";
